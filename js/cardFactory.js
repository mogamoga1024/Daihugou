...
class CardFactory {
    ...
    static #initCardList() {
        ...
        for (const suit of suitList) {
            ...
            this.#cardList.push({name: `${initial}J`, obj: new Card(suit.obj, "J",  `${initial}J`, 9,  `${imageFolderPath}/${suit.name}/card_${suit.name}_11.png`)});
            this.#cardList.push({name: `${initial}Q`, obj: new Card(suit.obj, "Q",  `${initial}Q`, 10, `${imageFolderPath}/${suit.name}/card_${suit.name}_12.png`)});
            this.#cardList.push({name: `${initial}K`, obj: new Card(suit.obj, "K",  `${initial}K`, 11, `${imageFolderPath}/${suit.name}/card_${suit.name}_13.png`)});
            this.#cardList.push({name: `${initial}1`, obj: new Card(suit.obj, "1",  `${initial}1`, 12, `${imageFolderPath}/${suit.name}/card_${suit.name}_1.png`) });
            this.#cardList.push({name: `${initial}2`, obj: new Card(suit.obj, "2",  `${initial}2`, 13, `${imageFolderPath}/${suit.name}/card_${suit.name}_2.png`) });
        }
