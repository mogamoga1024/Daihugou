...
(function() {
    ...
    test("思考 応手 multi 役なし", function() {
        const s3c3 = CardFactory.createCardList("s3, c3");
    ...
    test("思考 応手 multi 役なし", function() {
        const s7c7 = CardFactory.createCardList("s7, c7");
        const s1c1 = CardFactory.createCardList("s1, c1");
    ...
    test("思考 応手 multi 残り1役", function() {
        const d3h3 = CardFactory.createCardList("d3, h3");
        const s7c7 = CardFactory.createCardList("s7, c7");
        multiThinking = new MultiThinking([s7c7]);
    ...
    test("思考 応手 multi 残り2役 最強あり", function() {
        const d3h3 = CardFactory.createCardList("d3, h3");
        const s2c2 = CardFactory.createCardList("s2, c2");
    ...
    test("思考 応手 multi 残り2役 疑似最強あり", function() {
        const d3h3 = CardFactory.createCardList("d3, h3");
        const s1c1 = CardFactory.createCardList("s1, c1");
        multiThinking = new MultiThinking([s1c1]);

        strictEqual(Common.cardListToString(
            multiThinking.outputHandIfHandInBattleField(d3h3, 2, twoPower)), "s1, c1"
        );
    });
    ...
    test("思考 応手 multi 残り2役 最強なし", function() {
        ...
        multiThinking = new MultiThinking([s7c7, sKcK]);
    ...
    test("思考 応手 multi 残り3役", function() {
        const d3h3 = CardFactory.createCardList("d3, h3");
        const s7c7 = CardFactory.createCardList("s7, c7");
        const s9c9 = CardFactory.createCardList("s9, c9");
        const s2c2 = CardFactory.createCardList("s2, c2");
    ...
    test("思考 応手 multi 残り3役", function() {
        const d7h7 = CardFactory.createCardList("d7, h7");
        const s7c7 = CardFactory.createCardList("s7, c7");
        const s9c9 = CardFactory.createCardList("s9, c9");
        const s2c2 = CardFactory.createCardList("s2, c2");
        multiThinking = new MultiThinking([s7c7, s9c9, s2c2]);
